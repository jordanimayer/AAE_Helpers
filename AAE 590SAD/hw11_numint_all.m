...
function y_prime = hw11_numint_all(v, y)
    global K;  % shape variables declared in hw11_sim_and_plot
    ...
    w1_prime = 2*pi*K(1)*(w2*w3 - 6*(1 - 2*q3^2 - 2*q1^2)*(q2*q3 - q1*q4));
    w2_prime = 2*pi*K(2)*(w3*w1 - 12*(q1*q2 + q3*q4)*(q2*q3 - q1*q4));
    w3_prime = 2*pi*K(3)*(w1*w2 - 6*(q1*q2 + q3*q4)*(1 - 2*q3^2 - 2*q1^2));
