...
%   using orbit characteristics and change in mean anomaly. Identical to
%   state_vectors, but with suppressed outputs.
%
% Inputs:
...
function [r, v] = state_vectors_quiet(mu, a, e, i, raan, aop, t_0, M_0, ...
    t_1)
